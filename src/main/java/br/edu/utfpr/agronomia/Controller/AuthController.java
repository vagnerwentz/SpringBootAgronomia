...
import br.edu.utfpr.agronomia.DTO.AuthDTO;
import br.edu.utfpr.agronomia.DTO.MessageDTO;
import br.edu.utfpr.agronomia.DTO.PersonDTO;
import br.edu.utfpr.agronomia.Security.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<Object> loginHandler(@Valid @RequestBody AuthDTO body,
        ...
        try {
            ...
            claims.put("email", body.getEmail());
            ...
            ex.printStackTrace();
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(MessageDTO.b("Invalid credentials"));
        }
    }
}
